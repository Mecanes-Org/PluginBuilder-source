# 🇬🇧 PluginBuild  
### 🚀 The ultimate tool to build your Unreal Engine plugins
...
- 🔧 **Automatic plugin builds** for multiple Unreal Engine versions  
- 📦 **Full packaging pipeline** with structured output  
- 🚀 **One-click Fab-ready export**  
...
- Avoid build mistakes and manual errors  
...
1. Select your plugin folder  
2. Choose the Unreal Engine versions to build for  
3. Click **Build**  
